...
<div style="max-width:1100px;margin:14px auto 0;padding:0 20px;font-size:13px;color:#6a6a7a;display:flex;gap:14px;flex-wrap:wrap;">{job_link_html(name)}<a href="../专业课选择/考研专业课院校查询.html" style="display:inline-flex;align-items:center;gap:6px;padding:9px 18px;border-radius:10px;border:1px solid #f2dede;background:#fff;color:#a92122;font-weight:600;font-size:13px;text-decoration:none;box-shadow:0 1px 3px rgba(169,33,34,0.08);transition:all .18s;">专业课院校查询</a></div>
<div class="wrap">
  <h2>一、学院与专业</h2>
  <div class="card">
